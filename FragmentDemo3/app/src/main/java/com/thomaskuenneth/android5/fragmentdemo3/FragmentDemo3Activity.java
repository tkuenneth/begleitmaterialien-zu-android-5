package com.thomaskuenneth.android5.fragmentdemo3;
...
public class FragmentDemo3Activity extends Activity {
    ...
    public static class AuswahlFragment extends ListFragment {
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            // prüfen, ob das Details-Fragment direkt eingebunden werden kann
            // (dazu muss es im Layout ein Element mit der Id details geben)
            ...
            if (zweiSpaltenModus) {
                // Im Zweispalten-Modus invertiert die View das selektierte Element
    ...
    public static class DetailsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (container != null) {
                ...
                text.setText("Element #" + (1 + getIndex()) + " ist sichtbar");
            }
            return scroller;
        }
    }
