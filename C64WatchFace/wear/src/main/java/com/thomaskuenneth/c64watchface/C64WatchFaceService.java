...
public class C64WatchFaceService extends CanvasWatchFaceService {
    ...
    private static final String TAG = C64WatchFaceService.class.getSimpleName();
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(C64WatchFaceService.this)
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(C64WatchFaceService.this)
            ...
            C64WatchFaceUtil.fetchConfigDataMap(mGoogleApiClient,
                    new C64WatchFaceUtil.FetchConfigDataMapCallback() {
                        ...
                        public void onConfigDataMapFetched(DataMap startupConfig) {
                            ...
                            addBooleanKeyIfMissing(startupConfig, C64WatchFaceUtil.KEY_SECONDS_VISIBLE, false);
                            addBooleanKeyIfMissing(startupConfig, C64WatchFaceUtil.KEY_DATE_VISIBLE, false);
                            C64WatchFaceUtil.putConfigDataItem(mGoogleApiClient, startupConfig);
        ...
        private void registerReceiver() {
            ...
            C64WatchFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            mRegisteredTimeZoneReceiver = false;
            C64WatchFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }
